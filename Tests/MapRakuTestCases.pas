...
begin
  ...
  try
    ...
    Check(Restored.LayerCount=4,'Invalid load must preserve document');
    ...
    Writeln('PASS: insertion, undo/redo, same-level junction, level boundary, JSON validation, themes, symbols, path finish, SVG/PNG');
  finally
